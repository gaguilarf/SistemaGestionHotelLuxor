...
const CreateRoom = () => {
  ...
  const handleInputChange = (field, value) => {
    ...
    // Check number availability when numero changes
    if (field === 'numero' && value && value.length > 0) {
    ...
    <div className="space-y-4 md:space-y-6 p-4 md:p-0">
      ...
      <div className="flex flex-col space-y-3 md:flex-row md:items-center md:space-y-0 md:space-x-4">
        ...
        <div className="text-center md:text-left">
          <h1 className="text-xl md:text-2xl font-bold text-gray-900">Crear Nueva Habitación</h1>
          <p className="text-gray-600 text-sm">Registra una nueva habitación en el sistema</p>
        </div>
      </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  max="9999"
                />
                {formData.numero && (checking || numberAvailable !== null) && (
          ...
          <div className="bg-gray-50 px-4 md:px-6 py-3 md:py-4 border-t border-gray-200">
            <div className="flex flex-col space-y-3 md:flex-row md:justify-end md:space-y-0 md:space-x-3">
              ...
              <Button
                ...
                variant="primary"
                loading={loading}
                disabled={loading || !formData.numero || !formData.tipo || !formData.precio_noche || numberAvailable === false}
